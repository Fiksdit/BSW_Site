        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
          ...
          >
            <div className="flex items-start space-x-4">
              ...
              <div>
                <h3 className="mb-2 text-foreground" style={{ fontFamily: 'Cormorant, serif' }}>
                  Email
                </h3>
            ...
            <div className="flex items-start space-x-4">
              ...
              <div>
                ...
                <p className="text-primary" style={{ fontFamily: 'Inter, sans-serif' }}>
            ...
            <div className="bg-muted/50 rounded-lg p-6">
              <h3 className="text-xl mb-3 text-foreground" style={{ fontFamily: 'Cormorant, serif' }}>
                Individual or Group Sessions
              </h3>
              <p className="text-muted-foreground mb-4" style={{ fontFamily: 'Inter, sans-serif' }}>
                Customized consulting and professional development sessions available based on your needs:
              </p>
              <ul className="space-y-2 text-muted-foreground" style={{ fontFamily: 'Inter, sans-serif' }}>
          ...
          >
            <h3 className="text-2xl mb-6 text-foreground" style={{ fontFamily: 'Cormorant, serif' }}>
              Send us a message
            </h3>
            <form className="space-y-6">
              <div>
                <label htmlFor="name" className="block text-sm mb-2 text-foreground" style={{ fontFamily: 'Inter, sans-serif' }}>
                  Name
                </label>
                <input
                  type="text"
              ...
              <div>
                <label htmlFor="email" className="block text-sm mb-2 text-foreground" style={{ fontFamily: 'Inter, sans-serif' }}>
                  Email
                </label>
                <input
                  type="email"
              ...
              <div>
                <label htmlFor="subject" className="block text-sm mb-2 text-foreground" style={{ fontFamily: 'Inter, sans-serif' }}>
                  Subject
                </label>
                <select
                  id="subject"
              ...
              <div>
                <label htmlFor="message" className="block text-sm mb-2 text-foreground" style={{ fontFamily: 'Inter, sans-serif' }}>
                  Message
                </label>
                <textarea
                  id="message"
