      ...
      <div className="relative z-10 text-center px-4 sm:px-6 lg:px-8 max-w-4xl mx-auto">
        ...
        >
          ...
          <button
            ...
            className="px-8 py-3 bg-background/80 backdrop-blur-sm text-foreground rounded-full hover:bg-background transition-all duration-200 border border-border shadow-md hover:shadow-lg"
          >
            View Schedule
          </button>
        </motion.div>
